...
\begin{tikzpicture}[node distance=2.5cm and 3.5cm]
  ...
  \node[concrete, below right=-0.1cm and -2.50cm of niryows] (widowxws) {WidowXWorkspace\\{\scriptsize Concrete}};
  \node[concrete, below right=-0.1cm and -2.50cm of niryowss] (widowxwss) {WidowXWorkspaces\\{\scriptsize Concrete}};
  ...
  \draw[arrow] (widowxwss) -- node[above, label, font=\scriptsize] {creates} (widowxws);
  ...
  \node[draw, dashed, thick, fit=(workspace) (workspaces) (niryows) (niryowss) (widowxws) (widowxwss),
